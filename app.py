...
@app.command("/remove-messages")
def handle_remove_messages_command(ack, body, client, logger, command):
    """Handle the /remove-messages slash command"""
    ack()
    
    print("🗑️ /remove-messages command triggered!")
...
""" + ("✅ You have admin permissions - can remove any messages" if has_admin_perms else "👤 You can only remove your own messages")
        ...
        try:
            ...
            for msg in messages_to_process:
                ...
                if msg.get("subtype") == "bot_message" and "/remove-messages" in msg.get("text", ""):
